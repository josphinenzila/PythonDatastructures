...
return_day, return_month, return_year = [int(e) for e in input("Enter the return date: ").strip().split(' ')]
due_day, due_month, due_year = [int(e) for e in input("Enter the due date: ").strip().split(' ')]
